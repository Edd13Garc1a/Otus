Проект Otus:
Веб-приложение с мониторингом и репликацией базы данных и его аварийное восстановление🚀
...
Скрипт `5_backup_slave_and_push.sh` при первом запуске настраивает задачу Cron для ежедневного выполнения в 2:00 AM. 
Логи выполнения задачи записываются в `/var/log/backup.log`.
